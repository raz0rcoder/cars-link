...
 ![](/img/a.png)Talk button: Press to activate voice recognition/bring up menus/set destinations (if equipped with navigation) with minimal voice command prompts from the system. Press and hold to exit voice recognition

![](/img/b.png)Volume button: Press up/down to raise/lower speaker volume
...
![](/img/c.png)Receive/Place/End Call button: Press to receive/place/end calls. If no phone is paired, press the button to pair a phone
