...
*/
declare type MenuPlaceholderProps = {
    menuBoundingBox: any;
};
export declare const MenuPlaceholder: import("styled-components").StyledComponent<"div", any, MenuPlaceholderProps, never>;
declare type MenuWrapperProps = {
    menuFixed: boolean;
    menuBoundingBox: any;
