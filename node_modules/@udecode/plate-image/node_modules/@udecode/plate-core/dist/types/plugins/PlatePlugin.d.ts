 ...
 */
export declare type PlatePlugin<T = {}, P = {}> = Required<PlatePluginKey> & {
    editor?: Nullable<{
        /**
     ...
     */
    handlers?: Nullable<DOMHandlers<T, P> & {
        /**
         * @see {@link OnChange}
         */
...
export declare type WithPlatePlugin<T = {}, P = {}> = WithRequired<PlatePlugin<T, P>, 'type' | 'options' | 'inject' | 'editor'>;
