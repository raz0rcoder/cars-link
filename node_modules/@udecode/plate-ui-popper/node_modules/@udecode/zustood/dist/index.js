...
var createVanillaStore = require('zustand/vanilla');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var produce__default = /*#__PURE__*/_interopDefaultLegacy(produce);
var create__default = /*#__PURE__*/_interopDefaultLegacy(create);
var createVanillaStore__default = /*#__PURE__*/_interopDefaultLegacy(createVanillaStore);

const generateStateActions = store => {
  const actions = {};
...
const extendSelectors = (builder, api) => {
  ...
  Object.keys(builder(api.store.getState(), api.get, api)).forEach(key => {
    // @ts-ignore
    use[key] = (...args) => api.useStore(state => builder(state, api.get, api)[key])(...args); // @ts-ignore


    get[key] = (...args) => builder(api.store.getState(), api.get, api)[key](...args);
  });
  return { ...api,
    get,
    use
...
const immerMiddleware = config => (set, get, api) => {
  const setState = fn => set(produce__default["default"](fn), true);
...
const createStore = name => (initialState, options = {}) => {
  ...
  produce.setAutoFreeze((_immer$enabledAutoFre = immer === null || immer === void 0 ? void 0 : immer.enabledAutoFreeze) !== null && _immer$enabledAutoFre !== void 0 ? _immer$enabledAutoFre : false);
  ...
  if (persist !== null && persist !== void 0 && persist.enabled) {
    middlewares.push(config => middleware.persist(config, { ...persist,
      name
    }));
  }

  if (devtools !== null && devtools !== void 0 && devtools.enabled) {
    middlewares.push(config => middleware.devtools(config, { ...devtools,
      name
    }));
  }

  middlewares.push(createVanillaStore__default["default"]);

  const createStore = createState => pipe(createState, ...middlewares);

  const store = createStore(() => initialState);
  const useStore = create__default["default"](store);
...
exports.extendSelectors = extendSelectors;
exports.generateStateActions = generateStateActions;
exports.generateStateGetSelectors = generateStateGetSelectors;
exports.generateStateHookSelectors = generateStateHookSelectors;
exports.immerMiddleware = immerMiddleware;
exports.mapValuesKey = mapValuesKey;
exports.pipe = pipe;
