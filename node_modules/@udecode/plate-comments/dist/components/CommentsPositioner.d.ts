...
export declare const useCommentsPositioner: (props?: CommentsPositionerProps) => {
    style: {
        top: number;
        left: number;
...
export declare const CommentsPositioner: import("@udecode/plate-common").Component<CommentsPositionerProps>;
//# sourceMappingURL=CommentsPositioner.d.ts.map