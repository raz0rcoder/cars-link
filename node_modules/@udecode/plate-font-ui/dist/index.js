...
const ColorButton = ({
  ...
  const styles = getColorButtonStyles({
    value,
    isBrightColor
  });
  const content = /*#__PURE__*/React__default['default'].createElement(_StyledButton$2, {
  ...
  return name ? /*#__PURE__*/React__default['default'].createElement(index, {
    content: name
  }, content) : content;
};
...
var _StyledButton$2 = _styled__default['default']("button").withConfig({
  ...
  componentId: "sc-1dyqaqb-0"
})(["", ""], p => p.$_css);

const getColorInputStyles = props => plateStyledComponents.createStyles({
  prefixClassNames: 'ColorInput',
  ...props
}, {
  root: [_styled.css(["display:flex;flex-direction:column;align-items:center;"])],
  input: [_styled.css(["width:0;height:0;padding:0;margin:0;border:0;overflow:hidden;"])]
});
...
function ColorInput({
  ...
  return /*#__PURE__*/React__default['default'].createElement(_StyledDiv$2, {
    ...
    value: value,
    $_css2: (_styles$input = styles.input) === null || _styles$input === void 0 ? void 0 : _styles$input.css
  }));
}

var _StyledDiv$2 = _styled__default['default']("div").withConfig({
  displayName: "ColorInput___StyledDiv",
  componentId: "sc-iecy74-0"
})(["", ""], p => p.$_css);

var _StyledInput = _styled__default['default']("input").withConfig({
  displayName: "ColorInput___StyledInput",
  componentId: "sc-iecy74-1"
})(["", ""], p => p.$_css2);

const getColorPickerStyles = () => plateStyledComponents.createStyles({
...
const getColorsStyles = () => plateStyledComponents.createStyles({
  prefixClassNames: 'Colors'
}, {
  root: [_styled.css(["display:grid;grid-template-columns:repeat(10,1fr);gap:0.25rem;"])]
});
...
const Colors = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(_StyledDiv$1, {
    $_css: styles.root.css
  }, colors.map(({
    name,
    value,
    isBrightColor
  }) => /*#__PURE__*/React__default['default'].createElement(ColorButton, {
...
const CustomColors = ({
  ...
  const [customColor, setCustomColor] = React.useState(); // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(ColorInput, {
    value: value,
    onChange: e => {
      setValue(e.target.value);
      updateCustomColorDebounced(e.target.value);
    }
  }, /*#__PURE__*/React__default['default'].createElement(_StyledButton$1, null, "CUSTOM")), /*#__PURE__*/React__default['default'].createElement(Colors, {
    color: color,
...
var _StyledButton$1 = _styled__default['default'](plateUiButton.Button).withConfig({
  displayName: "CustomColors___StyledButton",
  componentId: "sc-3xv0na-0"
})({
  "width": "100%",
  "paddingTop": "0.5rem",
...
const ColorPicker = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(_StyledDiv, {
    ...
    $_css: styles.root.css
  }, /*#__PURE__*/React__default['default'].createElement(CustomColors, {
    color: color,
    colors: colors,
  ...
  }), /*#__PURE__*/React__default['default'].createElement(_StyledDiv2, null), /*#__PURE__*/React__default['default'].createElement(Colors, {
    color: color,
    colors: colors,
    selectedIcon: selectedIcon,
    updateColor: updateColor
...
var _StyledButton = _styled__default['default'](plateUiButton.Button).withConfig({
  displayName: "ColorPicker___StyledButton",
  componentId: "sc-swnf2m-2"
})({
  "width": "100%",
  "paddingTop": "0.5rem",
  "paddingBottom": "0.5rem"
...
const ColorPickerToolbarDropdown = ({
  ...
  const editorRef = plateCore.usePlateEditorRef();
  const type = plateCore.getPlatePluginType(editorRef, pluginKey);
  ...
  const updateColor = React.useCallback(value => {
    if (editorRef && editor && editor.selection) {
      ...
      slate.Transforms.select(editorRef, editor.selection);
  ...
  return /*#__PURE__*/React__default['default'].createElement(plateToolbar.ToolbarDropdown, {
    control: /*#__PURE__*/React__default['default'].createElement(plateToolbar.ToolbarButton, _extends({
...
exports.ColorPickerToolbarDropdown = ColorPickerToolbarDropdown;
exports.Colors = Colors;
exports.CustomColors = CustomColors;
exports.DEFAULT_COLORS = DEFAULT_COLORS;
exports.DEFAULT_CUSTOM_COLORS = DEFAULT_CUSTOM_COLORS;
exports.getColorButtonStyles = getColorButtonStyles;
exports.getColorInputStyles = getColorInputStyles;
exports.getColorPickerStyles = getColorPickerStyles;
exports.getColorsStyles = getColorsStyles;
