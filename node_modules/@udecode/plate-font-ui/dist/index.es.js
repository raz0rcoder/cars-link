...
import React, { forwardRef as forwardRef$1, cloneElement, useState, useLayoutEffect, useEffect, useRef, useCallback, useMemo } from 'react';
import { createPortal } from 'react-dom';
import { Button } from '@udecode/plate-ui-button';
import { getMark, setMarks, removeMark, isMarkActive } from '@udecode/plate-common';
import { usePlateEditorState, usePlateEditorRef, getPlatePluginType } from '@udecode/plate-core';
import { ToolbarDropdown, ToolbarButton } from '@udecode/plate-toolbar';
import { Transforms } from 'slate';
import { ReactEditor } from 'slate-react';

const getColorButtonStyles = props => createStyles({
  ...
  root: [{
    ...
    "borderWidth": "0px",
    "borderRadius": "9999px"
  }, css(["background-color:", ";:hover{box-shadow:0px 0px 5px 1px #9a9a9a;}:focus{box-shadow:0px 0px 5px 1px #676767;}"], props.value), {
    "borderWidth": "2px",
    "--tw-border-opacity": "1",
...
const ColorButton = ({
  ...
  const content = /*#__PURE__*/React.createElement(_StyledButton$2, {
  ...
  return name ? /*#__PURE__*/React.createElement(index, {
    content: name
  }, content) : content;
};
...
const getColorInputStyles = props => createStyles({
  prefixClassNames: 'ColorInput',
  ...props
}, {
  root: [css(["display:flex;flex-direction:column;align-items:center;"])],
  input: [css(["width:0;height:0;padding:0;margin:0;border:0;overflow:hidden;"])]
});
...
const getColorPickerStyles = () => createStyles({
...
const getColorsStyles = () => createStyles({
  prefixClassNames: 'Colors'
}, {
  root: [css(["display:grid;grid-template-columns:repeat(10,1fr);gap:0.25rem;"])]
});
...
const CustomColors = ({
  ...
  const [customColor, setCustomColor] = useState(); // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ColorInput, {
    value: value,
    onChange: e => {
      setValue(e.target.value);
      updateCustomColorDebounced(e.target.value);
    }
  }, /*#__PURE__*/React.createElement(_StyledButton$1, null, "CUSTOM")), /*#__PURE__*/React.createElement(Colors, {
    color: color,
...
const ColorPicker = ({
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv, {
    ...
    $_css: styles.root.css
  }, /*#__PURE__*/React.createElement(CustomColors, {
    color: color,
    colors: colors,
  ...
  }), /*#__PURE__*/React.createElement(_StyledDiv2, null), /*#__PURE__*/React.createElement(Colors, {
    color: color,
    colors: colors,
    selectedIcon: selectedIcon,
    updateColor: updateColor
...
export { ColorButton, ColorInput, ColorPicker, ColorPickerToolbarDropdown, Colors, CustomColors, DEFAULT_COLORS, DEFAULT_CUSTOM_COLORS, getColorButtonStyles, getColorInputStyles, getColorPickerStyles, getColorsStyles };
