...
const insertTableColumn = (editor, {
  ...
  plateCommon.withoutNormalizing(editor, () => {
    ...
    tableNode.children.forEach((row, rowIndex) => {
      ...
      const isHeaderRow = header === undefined ? row.children[0].type === plateCommon.getPluginType(editor, ELEMENT_TH) : header;
...
const insertTableRow = (editor, {
  ...
  plateCommon.withoutNormalizing(editor, () => {
    plateCommon.insertElements(editor, getEmptyRowNode(editor, {
      header,
...
const getCellInPreviousTableRow = (editor, currentRowPath) => {
  ...
  const previousRow = plateCommon.getNodeEntry(editor, slate.Path.previous(currentRowPath));
...
const getPreviousTableCell = (editor, currentCell, currentPath, currentRow) => {
  const cell = plateCommon.getNodeEntry(editor, slate.Path.previous(currentPath));
  if (cell) return cell;
  const [, currentRowPath] = currentRow;
...
const preventDeleteTableCell = (editor, {
  ...
  const getPoint = !reverse ? plateCommon.getStartPoint : plateCommon.getEndPoint;
  const getNextPoint = !reverse ? plateCommon.getPointBefore : plateCommon.getPointAfter;
      ...
      if (cellEntries.length > 1) {
        plateCommon.withoutNormalizing(editor, () => {
          ...
          plateCommon.select(editor, {
            ...
            focus: plateCommon.getEndPoint(editor, cellEntries[cellEntries.length - 1][1])
          });
        });
        return;
      }
      ...
      if (slate.Range.isRange(newSelection) && plateCommon.isRangeAcrossBlocks(editor, {
        ...
        if (!anchorEntry) {
          ...
          if (isBackward) {
            ...
            const pointBefore = plateCommon.getPointBefore(editor, anchorPath); // if the table is the first block
...
const useTableCellElementResizableProps = ({
  ...
  const handleResizeRight = React.useCallback(({
    ...
    const currentNew = roundCellSizeToStep(resizable.resizeLengthClampStatic(currentInitial + delta, {
      min: minColumnWidth,
  ...
  const handleResizeLeft = React.useCallback(event => {
    ...
    const newMargin = roundCellSizeToStep(resizable.resizeLengthClampStatic(marginLeft + event.delta, {
      min: 0,
...
const TableCellElementResizable = plateCommon.createComponentAs(props => {
  const editor = plateCommon.usePlateEditorRef();
  const {
    disableMarginLeft
  } = plateCommon.getPluginOptions(editor, ELEMENT_TABLE);
  ...
  return !readOnly && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(resizable.ResizeHandle, rightProps), /*#__PURE__*/React__default["default"].createElement(resizable.ResizeHandle, bottomProps), hasLeftHandle && /*#__PURE__*/React__default["default"].createElement(resizable.ResizeHandle, leftProps));
});

const TableCellElementResizableWrapper = plateCommon.createComponentAs(props => plateCommon.createElementAs('div', {
...
const useTableCellElementRootProps = props => {
  ...
  return {
    ...
    ...plateCommon.useElementProps(props)
  };
};
const TableCellElementRoot = plateCommon.createComponentAs(props => {
  const htmlProps = useTableCellElementRootProps(props);
  return plateCommon.createElementAs('td', htmlProps);
});

const TableCellElement = {
  Content: plateCommon.Box,
  Handle: plateCommon.Box,
...
const TableElementCol = plateCommon.createComponentAs(props => plateCommon.createElementAs('col', props));
...
const TableElementColGroup = plateCommon.createComponentAs(props => {
  const htmlProps = useTableElementColGroupProps(props);
  return plateCommon.createElementAs('colgroup', htmlProps);
});
...
const TableElementRoot = plateCommon.createComponentAs(props => {
  const htmlProps = useTableElementRootProps(props);
  return plateCommon.createElementAs('table', htmlProps);
});

const TableElementTBody = plateCommon.createComponentAs(props => plateCommon.createElementAs('tbody', props));

const TableElement = {
  Wrapper: plateCommon.Box,
...
const TableRowElementRoot = plateCommon.createComponentAs(props => plateCommon.createElementAs('tr', plateCommon.useElementProps(props)));
...
const ArrowDropDownCircleIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const BorderAllIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const BorderBottomIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
const BorderLeftIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
const BorderNoneIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
const BorderOuterIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
const BorderRightIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
const BorderTopIcon = props => /*#__PURE__*/React__default["default"].createElement("svg", _extends({
  width: "15",
  height: "15",
  viewBox: "0 0 15 15",
  fill: "none",
...
exports.TableCellElementResizable = TableCellElementResizable;
exports.TableCellElementResizableWrapper = TableCellElementResizableWrapper;
exports.TableCellElementRoot = TableCellElementRoot;
exports.TableElement = TableElement;
exports.TableElementCol = TableElementCol;
exports.TableElementColGroup = TableElementColGroup;
exports.TableElementRoot = TableElementRoot;
exports.TableElementTBody = TableElementTBody;
exports.TableRowElement = TableRowElement;
exports.TableRowElementRoot = TableRowElementRoot;
...
exports.useTableCellElementResizableProps = useTableCellElementResizableProps;
exports.useTableCellElementRootProps = useTableCellElementRootProps;
exports.useTableCellElementState = useTableCellElementState;
exports.useTableColSizes = useTableColSizes;
exports.useTableElementColGroupProps = useTableElementColGroupProps;
exports.useTableElementRootProps = useTableElementRootProps;
