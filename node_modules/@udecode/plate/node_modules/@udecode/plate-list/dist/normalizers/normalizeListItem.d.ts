 ...
 */
export declare const getDeepInlineChildren: (editor: PlateEditor, { children, }: {
 ...
 */
export declare const normalizeListItem: (editor: PlateEditor, { listItem, validLiChildrenTypes, }: {
