 ...
 */
export declare const moveListItemsToList: (editor: PlateEditor, { fromList, fromListItem, fromStartIndex, to: _to, toList, toListIndex, deleteFromList, }: MergeListItemIntoListOptions) => undefined;
