...
const withMention = ({
  ...
  editor.options[pluginKey] = defaults_1(options, {
    pluginKey,
    type: pluginKey,
    id: pluginKey,
...
const createMentionPlugin = options => {
  const {
    pluginKey = ELEMENT_MENTION
...
export { COMBOBOX_TRIGGER_MENTION, ELEMENT_MENTION, ELEMENT_MENTION_INPUT, createMentionPlugin, findMentionInput, getMentionDeserialize, getMentionInputPluginOptions, getMentionInputType, getMentionOnSelectItem, isNodeMentionInput, isSelectionInMentionInput, moveSelectionByOffset, removeMentionInput, withMention };
