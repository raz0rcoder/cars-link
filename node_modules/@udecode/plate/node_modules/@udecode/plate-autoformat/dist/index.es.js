import { ELEMENT_DEFAULT, getRangeFromBlockStart, someNode, getText, getRangeBefore, setNodes, getPointBefore, removeMark, isCollapsed } from '@udecode/plate-common';
...
const createAutoformatPlugin = getPlatePluginWithOverrides(withAutoformat);
