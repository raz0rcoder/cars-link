...
const setIndent = (editor, {
  ...
  nodes.forEach(([node, path]) => {
    var _node$nodeKey, _setNodesProps;

    const blockIndent = (_node$nodeKey = node[nodeKey]) !== null && _node$nodeKey !== void 0 ? _node$nodeKey : 0;
...
const getIndentOnKeyDown = () => editor => e => {
...
const withIndent = options => editor => {
  ...
  editor.options[KEY_INDENT] = defaults_1(options, {
    nodeKey: KEY_INDENT,
    validTypes: [plateCore.getPlatePluginType(editor, plateCommon.ELEMENT_DEFAULT)],
    offset: 24,
    unit: 'px',
    styleKey: 'marginLeft',
    transformNodeValue: (e, {
      nodeValue
    }) => {
      const {
        offset,
        unit
      } = plateCore.getPlatePluginOptions(e, KEY_INDENT);
...
const createIndentPlugin = options => ({
  overrideProps: plateCommon.getOverrideProps(KEY_INDENT),
...
exports.getIndentOnKeyDown = getIndentOnKeyDown;
