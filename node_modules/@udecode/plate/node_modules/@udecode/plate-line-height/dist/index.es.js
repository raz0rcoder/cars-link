import { getOverrideProps, ELEMENT_DEFAULT, unsetNodes, setNodes } from '@udecode/plate-common';
import { getPlatePluginType, getPlatePluginOptions } from '@udecode/plate-core';
...
const DEFAULT_LINE_HEIGHTS = [1, 1.2, 1.5, 2, 3];
...
const setLineHeight = (editor, {
  ...
  const match = n => Editor.isBlock(editor, n) && validTypes.includes(n.type);
...
export { DEFAULT_LINE_HEIGHT, DEFAULT_LINE_HEIGHTS, KEY_LINE_HEIGHT, createLineHeightPlugin, setLineHeight };
