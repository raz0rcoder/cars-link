import { getPlatePluginOptions, getPlatePluginType, getSlateClass, isElement, getRenderElement } from '@udecode/plate-core';
import { astDeserializerId } from '@udecode/plate-ast-serializer';
import { findNode, getElementDeserializer, someNode, getParent, getAbove, getNodes, isExpanded, getText, isSelectionAtBlockStart, setNodes, wrapNodes, insertNodes, ELEMENT_DEFAULT, isBlockAboveEmpty, unwrapNodes } from '@udecode/plate-common';
...
const getCodeBlockPluginOptions = editor => getPlatePluginOptions(editor, ELEMENT_CODE_BLOCK);

const getCodeBlockType = editor => getPlatePluginType(editor, ELEMENT_CODE_BLOCK);

const getCodeLinePluginOptions = editor => getPlatePluginOptions(editor, ELEMENT_CODE_LINE);

const getCodeLineType = editor => getPlatePluginType(editor, ELEMENT_CODE_LINE);
...
const getCodeBlockDeserialize = () => editor => {
  ...
  return {
    isDisabled: deserializerId => {
      ...
      const isSelectionInCodeLine = findNode(editor, {
        match: {
          type: code_line.type
        }
      }) !== undefined;
...
export { CODE_BLOCK_LANGUAGES, CODE_BLOCK_LANGUAGES_POPULAR, DEFAULTS_CODE_BLOCK, ELEMENT_CODE_BLOCK, ELEMENT_CODE_LINE, KEYS_CODE_BLOCK, MARK_PRISM, createCodeBlockPlugin, deleteStartSpace, getCodeBlockDecorate, getCodeBlockDeserialize, getCodeBlockInsertFragment, getCodeBlockOnKeyDown, getCodeBlockPluginOptions, getCodeBlockRenderLeaf, getCodeBlockType, getCodeLineDecorate, getCodeLineEntry, getCodeLinePluginOptions, getCodeLineType, getCodeLines, getIndentDepth, indentCodeLine, insertCodeBlock, insertCodeLine, insertEmptyCodeBlock, outdentCodeLine, toggleCodeBlock, unwrapCodeBlock, withCodeBlock };
