 ...
 */
export declare const createPlateOptions: <T extends string = string>(overrides?: Partial<Record<DefaultPlatePluginKey | T, Partial<PlatePluginOptions<import("@udecode/plate-core").AnyObject>>>> | undefined) => Record<DefaultPlatePluginKey | T, PlatePluginOptions<import("@udecode/plate-core").AnyObject>>;
