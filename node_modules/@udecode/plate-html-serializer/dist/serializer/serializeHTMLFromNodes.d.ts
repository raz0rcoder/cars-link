import { PlateEditor, PlatePlugin, SlateProps, TDescendant } from '@udecode/plate-core';
/**
 * Convert Slate Nodes into HTML string
 */
export declare const serializeHTMLFromNodes: (editor: PlateEditor, { plugins, nodes, slateProps, stripDataAttributes, preserveClassNames, stripWhitespace, }: {
    /**
