...
const getNode = (editor, {
  ...
  let html;
  const overriders = plugins.flatMap(plugin => castArray_1(plugin.overrideProps).flatMap(cb => {
    var _cb;
...
const getLeaf = (editor, {
  ...
  const overriders = plugins.flatMap(p => castArray_1(p.overrideProps).flatMap(cb => {
    var _cb2;

    return (_cb2 = cb === null || cb === void 0 ? void 0 : cb(editor)) !== null && _cb2 !== void 0 ? _cb2 : [];
  }));
