...
const getBlockAbove = (editor, options = {}) => slate.getAboveNode(editor, { ...options,
  block: true
});
...
const pluginInjectProps = (editor, {
  ...
  if (validTypes && slate.isElement(node) && node.type && !validTypes.includes(node.type)) {
    return;
  }
...
const PlateEditable = ({
  ...
  plugins.forEach(plugin => {
    ...
    if (renderAfterEditable) {
      afterEditable = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, afterEditable, renderAfterEditable(editableProps));
    }

    if (renderBeforeEditable) {
      beforeEditable = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, beforeEditable, renderBeforeEditable(editableProps));
    }
  });
...
const toggleNodeType = (editor, options, editorNodesOptions) => {
  ...
  const isActive = slate.someNode(editor, { ...editorNodesOptions,
    match: {
      type: activeType
    }
  });
