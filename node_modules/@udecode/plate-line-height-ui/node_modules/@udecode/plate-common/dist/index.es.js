 ...
 */
const getOverrideProps = pluginKey => editor => options => {
  ...
  const value = (_transformNodeValue = transformNodeValue === null || transformNodeValue === void 0 ? void 0 : transformNodeValue(editor, transformOptions)) !== null && _transformNodeValue !== void 0 ? _transformNodeValue : nodeValue;
  ...
  if (classNames !== null && classNames !== void 0 && classNames[nodeValue] || transformClassName) {
    ...
    res.className = (_transformClassName = transformClassName === null || transformClassName === void 0 ? void 0 : transformClassName(editor, transformOptions)) !== null && _transformClassName !== void 0 ? _transformClassName : clsx(className, classNames === null || classNames === void 0 ? void 0 : classNames[value]);
  }

  if (styleKey) {
    var _transformStyle;

    res.style = (_transformStyle = transformStyle === null || transformStyle === void 0 ? void 0 : transformStyle(editor, transformOptions)) !== null && _transformStyle !== void 0 ? _transformStyle : { ...style,
      [styleKey]: value
    };
  }
