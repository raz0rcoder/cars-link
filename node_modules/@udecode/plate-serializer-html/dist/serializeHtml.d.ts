 ...
 */
export declare const serializeHtml: <V extends Value>(editor: PlateEditor<V>, { nodes, slateProps, stripDataAttributes, preserveClassNames, stripWhitespace, convertNewLinesToHtmlBr, }: {
    /**
