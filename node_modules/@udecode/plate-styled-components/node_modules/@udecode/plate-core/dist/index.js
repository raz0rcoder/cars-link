...
const withHOC = (HOC, Component) => props => /*#__PURE__*/React__default['default'].createElement(HOC, null, /*#__PURE__*/React__default['default'].createElement(Component, props));
...
const createHistoryPlugin = createPluginFactory({
  key: 'history',
  withOverrides: slateHistory.withHistory
});
...
const createReactPlugin = createPluginFactory({
  key: 'react',
  withOverrides: slateReact.withReact
});
...
const createPlateStore = (state = {}) => zustood.createStore(`plate-${state.id}`)({
  ...
  resetEditor: () => {
    ...
    _set.editor(withPlate(slate.createEditor(), {
      id: state.id,
...
const platesStore = zustood.createStore('plate')({}).extendActions(set => ({
  /**
...
const usePlateEffects = ({
  ...
  React.useEffect(() => {
    if (!editor && enabled) {
      ...
      plateActions.editor((_ref = editorProp) !== null && _ref !== void 0 ? _ref : withPlate(slate.createEditor(), {
        id,
        plugins: pluginsProp,
        disableCorePlugins
      }));
...
const Plate = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(PlateContent, props);
};
...
const elementToHtml = (editor, {
  ...
  editor.plugins.some(plugin => {
    ...
    html = server.renderToStaticMarkup(createElementWithSlate({ ...slateProps,
...
const leafToHtml = (editor, {
  ...
  return editor.plugins.reduce((result, plugin) => {
    ...
    let html = decodeURIComponent(server.renderToStaticMarkup(createElementWithSlate({ ...slateProps,
      children: serialized
    })));
    html = stripClassNames(html, {
      preserveClassNames
