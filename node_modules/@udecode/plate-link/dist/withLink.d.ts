 ...
 *
 */
export declare const withLink: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(editor: E, { type, options: { isUrl, getUrlHref, rangeBeforeOptions }, }: WithPlatePlugin<LinkPlugin, V, E>) => E;
