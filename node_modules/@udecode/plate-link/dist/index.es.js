import { getPluginType, getPluginOptions, sanitizeUrl, createComponentAs, createElementAs, useElementProps, createStore, findNode, getEditorString, useEditorRef, mergeProps, useComposedRef, usePlateSelection, insertNodes, focusEditor, withoutNormalizing, getAboveNode, splitNodes, isElement as isElement$2, unwrapNodes, replaceNodeChildren, wrapNodes, isDefined, setNodes, isExpanded, removeNodes, getNodeProps, getNodeLeaf, toDOMRange, useHotkeys, usePlateSelectors, getStartPoint, getEndPoint, someNode, isRangeAcrossBlocks, useOnClickOutside, isCollapsed, isStartPoint, getPreviousNodeEndPoint, isEndPoint, getNextNodeStartPoint, select, mockPlugin, getRangeBefore, getRangeFromBlockStart, collapseSelection, createPluginFactory, isUrl } from '@udecode/plate-common';
...
const useFloatingLinkEdit = ({
  ...
  return {
    ...
    ...props,
    ref: useComposedRef(props.ref, refs.setFloating)
  };
};
...
const useFloatingLinkInsert = ({
  ...
  return {
    ...
    ...props,
    ref: useComposedRef(props.ref, refs.setFloating, ref)
  };
};
...
export { ELEMENT_LINK, FloatingLink, FloatingLinkEditButton, FloatingLinkEditRoot, FloatingLinkInsertRoot, FloatingLinkNewTabInput, FloatingLinkTextInput, FloatingLinkUrlInput, LaunchIcon, Link, LinkIcon, LinkOffIcon, LinkRoot, OpenLinkButton, ShortTextIcon, UnlinkButton, createLinkNode, createLinkPlugin, floatingLinkActions, floatingLinkSelectors, floatingLinkStore, getLinkAttributes, insertLink, submitFloatingLink, triggerFloatingLink, triggerFloatingLinkEdit, triggerFloatingLinkInsert, unwrapLink, upsertLink, upsertLinkText, useFloatingLinkEdit, useFloatingLinkEditButton, useFloatingLinkEnter, useFloatingLinkEscape, useFloatingLinkInsert, useFloatingLinkNewTabInput, useFloatingLinkSelectors, useFloatingLinkTextInput, useFloatingLinkUrlInput, useLink, useOpenLinkButton, useUnlinkButton, useVirtualFloatingLink, validateUrl, withLink, wrapLink };
