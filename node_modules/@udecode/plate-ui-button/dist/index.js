...
const getButtonStyles = props => {
  ...
  return plateStyledComponents.createStyles({
    ...
    root: [{
      ...
      paddingTop: py,
      paddingBottom: py
    }, _styled.css(["font-family:inherit;font-size:14px;border-radius:3px;"])]
  });
};
...
const Button = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(_StyledButton, _extends({
...
const DeleteIcon = props => /*#__PURE__*/React__default['default'].createElement(StyledIcon, _extends({
  viewBox: "0 0 24 24",
  fill: "currentColor"
}, props), /*#__PURE__*/React__default['default'].createElement("title", null, "Delete icon"), /*#__PURE__*/React__default['default'].createElement("path", {
  fill: "none",
  d: "M0 0h24v24H0z"
...
const RemoveNodeButton = ({
  ...
  }, props), /*#__PURE__*/React__default['default'].createElement(DeleteIcon, null));
};
