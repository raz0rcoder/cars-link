...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("tinacms"), require("react-use"), require("react-final-form"), require("styled-components"), require("@tinacms/toolkit"), require("react-textarea-autosize"), require("react-dropzone"), require("react-tinacms-editor"), require("react-is")) : typeof define === "function" && define.amd ? define(["exports", "react", "tinacms", "react-use", "react-final-form", "styled-components", "@tinacms/toolkit", "react-textarea-autosize", "react-dropzone", "react-tinacms-editor", "react-is"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["react-tinacms-inline"] = {}, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP, global.NOOP));
})(this, function(exports2, React, tinacms, reactUse, reactFinalForm, styled, toolkit, TextareaAutosize, reactDropzone, reactTinacmsEditor, require$$0) {
  "use strict";
  ...
  const FormFieldRenderer = ({ form }) => {
    const [fieldNodes, fieldNodeActions] = reactUse.useMap({});
    const [focusedField, setFocusedField] = React__namespace.useState("");
    const [attentionFields, attentionFieldActions] = reactUse.useMap({});
    tinacms.useCMSEvent(`form:${form.id}:ref:*`, ({ field: field2, node }) => {
      fieldNodeActions.set(field2, node);
    }, [fieldNodeActions.set]);
    tinacms.useCMSEvent(`form:${form.id}:fields:*:focus`, ({ field: field2 }) => {
      setFocusedField(field2);
    }, [setFocusedField]);
    tinacms.useCMSEvent(`form:${form.id}:fields:*:attentionStart`, ({ field: field2 }) => {
      attentionFieldActions.set(field2, true);
    }, [attentionFieldActions.set]);
    tinacms.useCMSEvent(`form:${form.id}:fields:*:attentionEnd`, ({ field: field2 }) => {
      attentionFieldActions.set(field2, false);
    }, [attentionFieldActions.set]);
    const field = React__namespace.useMemo(() => {
      return form.fields.find((field2) => field2.name === focusedField);
    }, [form.id, focusedField]);
    return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, Object.entries(attentionFields).filter(([, hasAttention]) => hasAttention).map(([field2]) => {
      return /* @__PURE__ */ React__namespace.createElement(FieldOverlay, {
        targetNode: fieldNodes[field2],
        attention: true
      });
    }), focusedField ? /* @__PURE__ */ React__namespace.createElement(FieldOverlay, {
      targetNode: fieldNodes[focusedField],
      attention: !(field && field.inlineComponent)
    }, field && field.inlineComponent ? /* @__PURE__ */ React__namespace.createElement(field.inlineComponent, {
      name: field.name
    }) : void 0) : null);
  };
  const InlineFieldsRenderer = () => {
    ...
    return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, forms.map((form) => /* @__PURE__ */ React__namespace.createElement(FormFieldRenderer, {
      form
    })));
  };
  function InlineForm({ form, children }) {
    const [focussedField, setFocussedField] = React__namespace.useState("");
    const cms = tinacms.useCMS();
    const rbie = React__namespace.useMemo(() => {
      return cms.plugins.getType("unstable_featureflag").find("ref-based-inline-editor");
    }, [cms.plugins]);
    const inlineFormState = React__namespace.useMemo(() => {
      return {
        form,
        focussedField,
        setFocussedField
    ...
    return /* @__PURE__ */ React__namespace.createElement(InlineFormContext.Provider, {
      value: inlineFormState
    }, /* @__PURE__ */ React__namespace.createElement(tinacms.Dismissible, {
    ...
    }, /* @__PURE__ */ React__namespace.createElement(tinacms.FormLegacy, {
      form
    }, (_a) => {
      var _b = _a, { form: form2 } = _b, formProps = __objRest(_b, ["form"]);
      return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, typeof children !== "function" ? children : children(__spreadValues(__spreadValues({}, formProps), inlineFormState)), (rbie == null ? void 0 : rbie.active) && /* @__PURE__ */ React__namespace.createElement(InlineFieldsRenderer, null));
    }))));
  }
  const InlineFormContext = React__namespace.createContext(null);
  function useInlineForm() {
    const inlineFormContext = React__namespace.useContext(InlineFormContext);
    if (!inlineFormContext) {
      throw new Error("useInlineForm must be within an InlineFormContext");
    }
    return inlineFormContext;
  }
  const InlineFieldContext = React__default["default"].createContext({});
  ...
  const getOffsetX = (offset2) => typeof offset2 === "object" ? offset2.x : offset2;
  const getOffsetY = (offset2) => typeof offset2 === "object" ? offset2.y : offset2;
  function AddBlockMenu({
    ...
    const addBlockButtonRef = React__namespace.useRef(null);
    const addBlockMenuRef = React__namespace.useRef(null);
    const [openTop, setOpenTop] = React__namespace.useState(false);
    const [filterValue, setFilterValue] = React__namespace.useState("");
    ...
    return /* @__PURE__ */ React__namespace.createElement(AddBlockWrapper, {
      index,
      offset: offset2,
      position: position2,
      isOpen
    }, /* @__PURE__ */ React__namespace.createElement(AddBlockButton, {
      ref: addBlockButtonRef,
      onClick: handleOpenBlockMenu,
      isOpen,
      primary: true,
      small: true
    }, /* @__PURE__ */ React__namespace.createElement(toolkit.AddIcon, null)), /* @__PURE__ */ React__namespace.createElement(BlocksMenu, {
      openTop,
      isOpen,
      ref: addBlockMenuRef
    }, Object.keys(blocks).length > 9 && /* @__PURE__ */ React__namespace.createElement(DropdownHeader, null, /* @__PURE__ */ React__namespace.createElement(SelectFilter, {
      placeholder: "Filter",
      ...
      value: filterValue
    })), /* @__PURE__ */ React__namespace.createElement(BlocksMenuOptions, null, Object.keys(blocks).filter((key) => {
      ...
      if (!template) {
        ...
        return /* @__PURE__ */ React__namespace.createElement(BlockOption, {
    ...
    }) : /* @__PURE__ */ React__namespace.createElement(BlockOption, {
      disabled: true
    }, "No blocks to display"))));
  }
  const AddBlockButton = styled__default["default"](toolkit.IconButton)`
  ...
  ${(props) => props.isOpen && styled.css`
    ...
    `};
`;
  const AddBlockWrapper = styled__default["default"].div((p) => {
    const offset2 = getOffset(p.offset);
    return styled.css`
    position: absolute;
    z-index: calc(
    ...
    ${p.position === "top" && styled.css`
      top: calc(-1 * ${getOffsetY(offset2)}px);
      left: 50%;
      transform: translate3d(-50%, -50%, 0);
    `}

    ${p.position === "left" && styled.css`
      top: 50%;
      left: calc(-1 * ${getOffsetX(offset2)}px);
      transform: translate3d(-50%, -50%, 0);
    `}

  ${p.position === "bottom" && styled.css`
      bottom: calc(-1 * ${getOffsetY(offset2)}px);
      left: 50%;
      transform: translate3d(-50%, 50%, 0);
    `}

  ${p.position === "right" && styled.css`
      top: 50%;
      right: calc(-1 * ${getOffsetX(offset2)}px);
      transform: translate3d(50%, -50%, 0);
    `}

  ${p.position === void 0 && styled.css`
      position: relative;
    `}
  ...
  const BlocksMenu = styled__default["default"].div`
  min-width: 192px;
  ...
  ${(props) => props.openTop && styled.css`
      ...
      ${props.isOpen && styled.css`
        transform: translate3d(-50%, -16px, 0) scale3d(1, 1, 1);
      `};
    `};
`;
  const BlocksMenuOptions = styled__default["default"].div`
  min-width: 192px;
  max-height: 25vh;
  display: flex;
  flex-direction: column;
...
`;
  const BlockOption = styled__default["default"].button`
  all: unset;
...
`;
  const SelectFilter = styled__default["default"](tinacms.Input)`
  height: 36px;
  flex: 0 1 auto;
...
`;
  const DefaultContainer = (props) => {
    return /* @__PURE__ */ React__namespace.createElement("div", __spreadValues({}, props));
  };
  const InlineBlocksContext = React__namespace.createContext(null);
  function useInlineBlocks() {
    const inlineBlocksContext = React__namespace.useContext(InlineBlocksContext);
  ...
  function InlineBlocks({
    ...
    return /* @__PURE__ */ React__namespace.createElement(InlineField, {
      name
    }, ({ input, form }) => {
      ...
      return /* @__PURE__ */ React__namespace.createElement(Container2, {
        className,
        style: style2
      }, /* @__PURE__ */ React__namespace.createElement(InlineBlocksContext.Provider, {
        value: {
          insert,
          duplicate,
          move: move2,
      ...
      }, allData.length < 1 && cms.enabled && /* @__PURE__ */ React__namespace.createElement(BlocksEmptyState, null, /* @__PURE__ */ React__namespace.createElement(AddBlockMenu, {
        ...
        return /* @__PURE__ */ React__namespace.createElement(InlineBlock, {
          itemProps,
          key: index,
          index,
          name: blockName,
  ...
  function InlineBlock({
    ...
    return React__namespace.useMemo(() => /* @__PURE__ */ React__namespace.createElement(InlineFieldContext.Provider, {
      value: __spreadValues({ name }, block)
    }, /* @__PURE__ */ React__namespace.createElement(block.Component, __spreadValues({
      data,
      name,
      index
    }, itemProps))), [
  ...
  const BlocksEmptyState = styled__default["default"].div`
...
`;
  const FocusRing = ({ name, options, children }) => {
    ...
    const [childActive, setChildActive] = React__namespace.useState(false);
    const { focussedField, setFocussedField } = useInlineForm();
    const focusRingRef = React__namespace.useRef(null);
    const borderRadius = typeof options === "object" ? options.borderRadius : void 0;
    const offset2 = typeof options === "object" ? options.offset : void 0;
    ...
    return /* @__PURE__ */ React__namespace.createElement(StyledFocusRing, {
      ref: focusRingRef,
      active,
  ...
  const StyledFocusRing = styled__default["default"].div((p) => {
    const offset2 = getOffset(p.offset);
    return styled.css`
    position: relative;
    width: 100%;
    ...
    &:after {
      ...
      left: calc(-1 * ${getOffsetX(offset2)}px);
      top: calc(-1 * ${getOffsetY(offset2)}px);
      width: calc(100% + ${getOffsetX(offset2) * 2}px);
      height: calc(100% + ${getOffsetY(offset2) * 2}px);
      border: 1px solid var(--tina-color-primary);
  ...
  function InlineText({
    ...
    return /* @__PURE__ */ React__namespace.createElement(InlineField, {
      ...
      if (cms.enabled) {
        if (!focusRing) {
          return /* @__PURE__ */ React__namespace.createElement(Input, __spreadProps(__spreadValues({
            type: "text"
          }, input), {
            placeholder,
            className
        ...
        return /* @__PURE__ */ React__namespace.createElement(FocusRing, {
          name: input.name,
          options: focusRing
        }, /* @__PURE__ */ React__namespace.createElement(Input, __spreadProps(__spreadValues({
          type: "text"
        }, input), {
          placeholder,
          className
      ...
      return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, children || input.value);
    });
  }
...
`;
  ...
  function InlineTextarea({
    ...
    const cms = tinacms.useCMS();
    return /* @__PURE__ */ React__default["default"].createElement(InlineField, {
      name
    }, ({ input }) => {
      if (cms.enabled) {
        if (!focusRing) {
          return /* @__PURE__ */ React__default["default"].createElement(Textarea, __spreadProps(__spreadValues({
            className
          }, input), {
            rows: 1,
            placeholder
        ...
        return /* @__PURE__ */ React__default["default"].createElement(FocusRing, {
          name: input.name,
          options: focusRing
        }, /* @__PURE__ */ React__default["default"].createElement(Textarea, __spreadProps(__spreadValues({
          className
        }, input), {
          rows: 1,
          placeholder
      ...
      return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, children || input.value);
    });
  }
  const Textarea = styled__default["default"](TextareaAutosize__default["default"])`
  width: 100%;
...
`;
  function DropzoneWrapper({
    ...
    return /* @__PURE__ */ React__namespace.createElement(Container, __spreadProps(__spreadValues({}, getRootProps()), {
      onClick,
      className
    }), /* @__PURE__ */ React__namespace.createElement("input", __spreadValues({}, getInputProps())), children);
  }
...
`;
  function NonEditableImage({
    ...
    return /* @__PURE__ */ React__namespace.createElement(Container, {
      className
    }, children ? children({ src }) : /* @__PURE__ */ React__namespace.createElement("img", {
      src,
      alt
    }));
  }
  function InlineImageUpload({
    ...
    if (!src)
      return /* @__PURE__ */ React__namespace.createElement(DropzoneWrapper, {
        onClick,
        onDrop,
        className
      }, /* @__PURE__ */ React__namespace.createElement(ImagePlaceholder, null));
    return /* @__PURE__ */ React__namespace.createElement(DropzoneWrapper, {
      onClick,
      onDrop,
      className
  ...
  const ImagePlaceholder = styled__default["default"]((styleProps) => {
    return /* @__PURE__ */ React__namespace.createElement("div", __spreadValues({}, styleProps), "Drag 'n' drop some files here,", /* @__PURE__ */ React__namespace.createElement("br", null), "or click to select files");
  })`
  width: 100%;
  height: 100%;
  display: flex;
...
`;
  function EditableImage({
    ...
    const cms = tinacms.useCMS();
    const [_previewSrc] = tinacms.usePreviewSrc(input.value, name, form.values, previewSrc);
    ...
    return /* @__PURE__ */ React__namespace.createElement(FocusRing, {
      name,
      options: focusRing
    }, /* @__PURE__ */ React__namespace.createElement(InlineImageUpload, {
      src: _previewSrc,
      alt,
  ...
  function InlineImage(props) {
    ...
    return /* @__PURE__ */ React__namespace.createElement(InlineField, {
      ...
      if (cms.enabled) {
        return /* @__PURE__ */ React__namespace.createElement(EditableImage, __spreadProps(__spreadValues({}, props), {
          input,
          form
        }));
      }
      return /* @__PURE__ */ React__namespace.createElement(NonEditableImage, {
  ...
  function InlineWysiwyg(_a) {
    ...
    return /* @__PURE__ */ React__namespace.createElement(InlineField, {
      ...
      return /* @__PURE__ */ React__namespace.createElement(FocusRing, {
        ...
        if (active) {
          return /* @__PURE__ */ React__namespace.createElement(reactTinacmsEditor.Wysiwyg, __spreadValues({
            input,
            imageProps,
            form
          }, wysiwygProps));
    ...
    return function wrapWithConnect(WrappedComponent) {
      ...
      function ConnectFunction(props) {
        ...
        var ContextToUse = React.useMemo(function() {
          return propsContext && propsContext.Consumer && require$$0.isContextConsumer(/* @__PURE__ */ React__default["default"].createElement(propsContext.Consumer, null)) ? propsContext : Context;
  ...
  */
  ...
  (function(exports3) {
    ...
    if (typeof window === "undefined" || typeof MessageChannel !== "function") {
      ...
      l = exports3.unstable_forceFrameRate = function() {
      };
    } else {
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var aa = React__default["default"], n = objectAssign, r = scheduler.exports;
  function u(a) {
  ...
  function getDisplacementGroups(_ref) {
    ...
    return afterDragging.reduce(function process(groups, draggable2) {
      ...
      groups.all.push(id2);
      var isVisible2 = isPartiallyVisible({
        target,
        destination,
        viewport,
  ...
  var whenReordering = function(_ref) {
    ...
    if (closestAfter) {
      var closest2 = draggables[closestAfter];
      ...
      var withDisplacement = offset(closest2.page, displacedBy.point);
      return goBefore({
        axis,
  ...
  var moveToNextPlace = function(_ref) {
    ...
    var distance2 = subtract(pageBorderBoxCenter, previousPageBorderBoxCenter);
  ...
  function atIndex(_ref) {
    var draggable2 = _ref.draggable, closest2 = _ref.closest, inHomeList = _ref.inHomeList;
    if (!closest2) {
      return null;
    }
    if (!inHomeList) {
  ...
  var getReorderImpact = function(_ref2) {
    ...
    var withoutDragging = removeDraggableFromList(draggable2, insideDestination);
    var closest2 = find(withoutDragging, function(child) {
  ...
  var reducer = function(state, action) {
    ...
    if (action.type === "UPDATE_VIEWPORT_MAX_SCROLL") {
      ...
      var withMaxScroll2 = _extends({}, state.viewport, {
  ...
  var moveTo = function moveTo2(offset2) {
    return isEqual(offset2, origin) ? null : "translate(" + offset2.x + "px, " + offset2.y + "px)";
  };
  var transforms = {
    moveTo,
    drop: function drop2(offset2, isCombining) {
  ...
  var getAsyncMarshal = function() {
    var entries = [];
    var execute2 = function execute3(timerId) {
    ...
    var add2 = function add3(fn) {
      var timerId = setTimeout(function() {
        return execute2(timerId);
      });
      var entry = {
        timerId,
        callback: fn
  ...
  var getPublisher = function(getResponders, announce) {
    ...
    var drop2 = function drop3(result) {
      !dragging ? invariant(false) : void 0;
      dragging = null;
    ...
    var collect = function collect2() {
      ...
      frameId = requestAnimationFrame(function() {
        ...
        var updated = Object.keys(modified).map(function(id2) {
          ...
          var scroll2 = entry.callbacks.getScrollWhileDragging();
          return {
            droppableId: id2,
            scroll: scroll2
          };
  ...
  var createDimensionMarshal = function(registry, callbacks) {
    ...
    var updateDroppableIsEnabled2 = function updateDroppableIsEnabled3(id2, isEnabled) {
    ...
    var updateDroppableIsCombineEnabled2 = function updateDroppableIsCombineEnabled3(id2, isCombineEnabled) {
      if (!collection) {
        return;
      }
      !registry.droppable.exists(id2) ? invariant(false) : void 0;
    ...
    var updateDroppableScroll2 = function updateDroppableScroll3(id2, newScroll) {
      if (!collection) {
        return;
      }
      !registry.droppable.exists(id2) ? invariant(false) : void 0;
  ...
  var getValueFromDistance = function(distanceToEdge, thresholds) {
    ...
    var scroll2 = config.maxPixelScroll * config.ease(percentageFromStartScrollingFrom);
  ...
  var dampenValueByTime = function(proposedScroll, dragStartTime) {
    ...
    var scroll2 = proposedScroll * config.ease(betweenAccelerateAtAndStopAtPercentage);
    return Math.ceil(scroll2);
  };
  var getValue = function(_ref) {
    ...
    var scroll2 = getValueFromDistance(distanceToEdge, thresholds);
    if (scroll2 === 0) {
      return 0;
    }
  ...
  var createJumpScroller = function(_ref) {
    var move2 = _ref.move, scrollDroppable2 = _ref.scrollDroppable, scrollWindow2 = _ref.scrollWindow;
  ...
  var createAutoScroller = function(_ref) {
    var scrollDroppable2 = _ref.scrollDroppable, scrollWindow2 = _ref.scrollWindow, move2 = _ref.move;
    ...
    var scroll2 = function scroll3(state) {
      if (state.phase !== "DRAGGING") {
        return;
      }
  ...
  var isEqual$1 = function isEqual2(base) {
    return function(value) {
      return base === value;
    };
  };
  ...
  var getDroppableDimension = function(_ref) {
    var descriptor = _ref.descriptor, isEnabled = _ref.isEnabled, isCombineEnabled = _ref.isCombineEnabled, isFixedOnPage = _ref.isFixedOnPage, direction = _ref.direction, client = _ref.client, page = _ref.page, closest2 = _ref.closest;
    var frame = function() {
      if (!closest2) {
        return null;
      }
      var scrollSize = closest2.scrollSize, frameClient = closest2.client;
      var maxScroll = getMaxScroll({
  ...
  function useDroppablePublisher(args) {
    ...
    var onClosestScroll = useCallback(function() {
      var dragging = whileDraggingRef.current;
      var closest2 = getClosestScrollableFromDrag(dragging);
      !(dragging && closest2) ? invariant(false) : void 0;
    ...
    var scroll2 = useCallback(function(change) {
      var dragging = whileDraggingRef.current;
      !dragging ? invariant(false) : void 0;
      var closest2 = getClosestScrollableFromDrag(dragging);
      !closest2 ? invariant(false) : void 0;
  ...
  function getDraggableSelector() {
    ...
    var getMemoizedProps = memoizeOne(function(offset2, mode, dimension, isClone, draggingOver, combineWith, forceShouldAnimate) {
      return {
        mapped: {
          type: "DRAGGING",
          dropping: null,
  ...
  function getSecondarySelector() {
    ...
    var getMemoizedProps = memoizeOne(function(offset2, combineTargetFor, shouldAnimateDisplacement) {
  ...
  function Droppable(props) {
    ...
    var children = props.children, droppableId = props.droppableId, type = props.type, mode = props.mode, direction = props.direction, ignoreContainerClipping = props.ignoreContainerClipping, isDropDisabled = props.isDropDisabled, isCombineEnabled = props.isCombineEnabled, snapshot = props.snapshot, useClone = props.useClone, updateViewportMaxScroll2 = props.updateViewportMaxScroll, getContainerForClone = props.getContainerForClone;
  ...
  var makeMapStateToProps$1 = function makeMapStateToProps2() {
  ...
  const BlockAction = styled__default["default"].div`
...
`;
  function InlineSettings({ fields }) {
    ...
    return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      onClick: toggleOpen
    }, /* @__PURE__ */ React__namespace.createElement(toolkit.EditIcon, null)), open && /* @__PURE__ */ React__namespace.createElement(SettingsModal, {
      fields,
      close: () => setOpen(false)
    }));
  }
  function SettingsModal({
    ...
    const { name } = React__namespace.useContext(InlineFieldContext);
    const [initialValues] = React__namespace.useState(form.values);
    ...
    return /* @__PURE__ */ React__namespace.createElement(tinacms.Modal, {
      id: "tinacms-inline-settings",
      onClick: (e) => e.stopPropagation()
    }, /* @__PURE__ */ React__namespace.createElement(tinacms.ModalPopup, null, /* @__PURE__ */ React__namespace.createElement(tinacms.ModalHeader, {
      close: handleCancel
    }, title), /* @__PURE__ */ React__namespace.createElement(tinacms.ModalBody, null, /* @__PURE__ */ React__namespace.createElement(DragDropContext, {
      onDragEnd: moveArrayItem
    }, /* @__PURE__ */ React__namespace.createElement(FormBody, null, /* @__PURE__ */ React__namespace.createElement(Wrapper, null, /* @__PURE__ */ React__namespace.createElement(tinacms.FieldsBuilder, {
      form,
      fields: formFields
    }))))), /* @__PURE__ */ React__namespace.createElement(tinacms.ModalActions, null, /* @__PURE__ */ React__namespace.createElement(toolkit.Button, {
      onClick: handleCancel
    }, "Cancel"), /* @__PURE__ */ React__namespace.createElement(toolkit.Button, {
      onClick: handleClose,
      disabled: form.values === initialValues,
      variant: "primary"
    }, "Confirm"))));
  }
  const FormBody = styled__default["default"](tinacms.FormPortalProvider)`
  position: relative;
  flex: 1 1 auto;
  display: flex;
  flex-direction: column;
...
`;
  function BlocksControls({
    ...
    const cms = tinacms.useCMS();
    const { focussedField, setFocussedField } = useInlineForm();
    const { name, template } = React__namespace.useContext(InlineFieldContext);
    const {
      insert,
      duplicate,
      move: move2,
    ...
    const blockMenuRef = React__namespace.useRef(null);
    const blockMoveUpRef = React__namespace.useRef(null);
    const blockMoveDownRef = React__namespace.useRef(null);
    ...
    const offset2 = typeof focusRing === "object" ? focusRing.offset : void 0;
    ...
    }, isActive && /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, withinLimit(max) && /* @__PURE__ */ React__namespace.createElement(AddBlockMenuWrapper, {
      active: isActive
    }, /* @__PURE__ */ React__namespace.createElement(AddBlockMenu, {
    ...
    })), /* @__PURE__ */ React__namespace.createElement(BlockMenuWrapper, {
      offset: offset2,
      ref: blockMenuRef,
      index,
      active: isActive,
      inset: insetControls
    }, label && /* @__PURE__ */ React__namespace.createElement(BlockLabel, null, template.label), /* @__PURE__ */ React__namespace.createElement(BlockMenuSpacer, null), /* @__PURE__ */ React__namespace.createElement(BlockMenu, null, /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      ref: blockMoveUpRef,
      onClick: moveBlockUp,
      disabled: isFirst
    }, direction === "vertical" && /* @__PURE__ */ React__namespace.createElement(toolkit.ChevronUpIcon, null), direction === "horizontal" && /* @__PURE__ */ React__namespace.createElement(toolkit.ChevronLeftIcon, null)), /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      ref: blockMoveDownRef,
      onClick: moveBlockDown,
      disabled: isLast
    }, direction === "vertical" && /* @__PURE__ */ React__namespace.createElement(toolkit.ChevronDownIcon, null), direction === "horizontal" && /* @__PURE__ */ React__namespace.createElement(toolkit.ChevronRightIcon, null)), customActions.map((x, i) => /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      key: i,
      onClick: () => x.onClick()
    }, x.icon)), withinLimit(max) && /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      onClick: duplicateBlock
    }, /* @__PURE__ */ React__namespace.createElement(toolkit.DuplicateIcon, null)), /* @__PURE__ */ React__namespace.createElement(InlineSettings, {
      fields: template.fields
    }), withinLimit(min) && /* @__PURE__ */ React__namespace.createElement(BlockAction, {
      onClick: removeBlock
    }, /* @__PURE__ */ React__namespace.createElement(toolkit.TrashIcon, null))))), children);
  }
  const AddBlockMenuWrapper = styled__default["default"].div((p) => styled.css`
    opacity: 0;
    transition: all var(--tina-timing-medium) ease-out;
    pointer-events: none;
    ...
    `}
  `);
  const BlockMenuWrapper = styled__default["default"].div((p) => {
    const offset2 = getOffset(p.offset);
    return styled.css`
    position: absolute;
    display: flex;
    ...
    top: calc(-1 * ${getOffsetY(offset2)}px - 16px);
    right: calc(-1 * ${getOffsetX(offset2)}px - 1px);
    left: calc(-1 * ${getOffsetX(offset2)}px - 1px);
    opacity: 0;
    transition: all var(--tina-timing-medium) ease-out;
    ...
    ${p.inset && styled.css`
      top: calc(14px - ${getOffsetY(offset2)}px);
      left: calc(14px - ${getOffsetX(offset2)}px);
      right: calc(14px - ${getOffsetX(offset2)}px);
  ...
  const BlockMenuSpacer = styled__default["default"].div`
  pointer-events: none;
  visibility: hidden;
  flex: 1 0 var(--tina-padding-small);
`;
  const BlockLabel = styled__default["default"].div`
  display: flex;
  flex: 0 0 auto;
  align-items: center;
...
`;
  function InlineGroupControls({
    ...
    const cms = tinacms.useCMS();
    const groupMenuRef = React__namespace.useRef(null);
    const { fields } = React__namespace.useContext(InlineFieldContext);
    const [active, setActive] = React__namespace.useState(false);
    const [childActive, setChildActive] = React__namespace.useState(false);
    const { focussedField, setFocussedField } = useInlineForm();
    const focusRingRef = React__namespace.useRef(null);
    ...
    return /* @__PURE__ */ React__namespace.createElement(StyledFocusRing, {
      ...
      inset: insetControls,
      active
    }, /* @__PURE__ */ React__namespace.createElement(BlockMenuSpacer, null), /* @__PURE__ */ React__namespace.createElement(BlockMenu, null, /* @__PURE__ */ React__namespace.createElement(InlineSettings, {
      fields
    }))), children);
  }
  function InlineGroup({
    ...
    let fieldName = name;
    const parentField = React__namespace.useContext(InlineFieldContext);
    if (parentField.name) {
      fieldName = `${parentField.name}.${name}`;
    }
    return /* @__PURE__ */ React__namespace.createElement(InlineFieldContext.Provider, {
      value: { name: fieldName, fields }
    }, /* @__PURE__ */ React__namespace.createElement(InlineGroupControls, {
      name: fieldName,
      insetControls,
      focusRing
    }, children));
  ...
  function BlockText(props) {
    return /* @__PURE__ */ React__namespace.createElement(InlineText, __spreadProps(__spreadValues({}, props), {
      focusRing: false
    }));
  }
  const BlockField = InlineField;
  function BlockTextarea(props) {
    return /* @__PURE__ */ React__namespace.createElement(InlineTextarea, __spreadProps(__spreadValues({}, props), {
      focusRing: false
    }));
  }
  function BlockImage(props) {
    return /* @__PURE__ */ React__namespace.createElement(InlineImage, __spreadProps(__spreadValues({}, props), {
      focusRing: false
    }));
  }
  const useFieldRef = (formId, fieldName) => {
    const [node, setNode] = React__namespace.useState(null);
    const [initialOpacity, setInitialOpacity] = React__namespace.useState("1.0");
    const cms = tinacms.useCMS();
    React__namespace.useEffect(() => {
      cms.events.dispatch({
    ...
    tinacms.useCMSEvent(`form:${formId}:fields:*:focus`, ({ field }) => {
      if (field === fieldName) {
    ...
    const handleHoverStart = React__namespace.useCallback((e) => {
      e.preventDefault();
      e.stopPropagation();
      cms.events.dispatch({
    ...
    const handleHoverEnd = React__namespace.useCallback((e) => {
      e.preventDefault();
      e.stopPropagation();
      cms.events.dispatch({
    ...
    return React__namespace.useCallback((newNode) => {
      setNode(newNode);
    }, []);
  };
  class RBIEPlugin {
  ...
  exports2.AddBlockMenu = AddBlockMenu;
  exports2.BlockField = BlockField;
  exports2.BlockImage = BlockImage;
  exports2.BlockLabel = BlockLabel;
  exports2.BlockMenu = BlockMenu;
  exports2.BlockMenuSpacer = BlockMenuSpacer;
  exports2.BlockMenuWrapper = BlockMenuWrapper;
  exports2.BlockText = BlockText;
  exports2.BlockTextarea = BlockTextarea;
  exports2.BlocksControls = BlocksControls;
  exports2.BlocksEmptyState = BlocksEmptyState;
  exports2.FieldOverlay = FieldOverlay;
  exports2.FocusRing = FocusRing;
  exports2.InlineBlock = InlineBlock;
  exports2.InlineBlocks = InlineBlocks;
  exports2.InlineBlocksContext = InlineBlocksContext;
  exports2.InlineField = InlineField;
  exports2.InlineFieldContext = InlineFieldContext;
  exports2.InlineFieldsRenderer = InlineFieldsRenderer;
  exports2.InlineForm = InlineForm;
  exports2.InlineFormContext = InlineFormContext;
  exports2.InlineGroup = InlineGroup;
  exports2.InlineGroupControls = InlineGroupControls;
  exports2.InlineImage = InlineImage;
  exports2.InlineImageField = InlineImageField;
  exports2.InlineSettings = InlineSettings;
  exports2.InlineText = InlineText;
  exports2.InlineTextField = InlineTextField;
  exports2.InlineTextarea = InlineTextarea;
  exports2.InlineTextareaField = InlineTextareaField;
  exports2.InlineWysiwyg = InlineWysiwyg;
  exports2.RBIEPlugin = RBIEPlugin;
  exports2.StyledFocusRing = StyledFocusRing;
  exports2.getOffset = getOffset;
  exports2.getOffsetX = getOffsetX;
  exports2.getOffsetY = getOffsetY;
  exports2.useFieldRef = useFieldRef;
  exports2.useInlineBlocks = useInlineBlocks;
  exports2.useInlineForm = useInlineForm;
